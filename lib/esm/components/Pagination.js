...
const Pagination = ({ onPageChange, currentPage = 1, pageSize, totalData, prev = React.createElement("span", null, "<"), next = React.createElement("span", null, ">"), paginationSize = 5, trimmer = true, }) => {
