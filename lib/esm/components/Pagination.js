...
const Pagination = ({ onPageChange, currentPage = 1, pageSize, totalData, prev = React.createElement("span", null, "<"), next = React.createElement("span", null, ">"), paginationSize = 5, trimmer = true, goto = true, }) => {
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement(Ul, null,
            totalPageCount > 1 && (React.createElement(Button, { disabled: currentPage === 1, onClick: () => PrevFunc(), key: "-1" }, prev)),
            trimmerState ? (React.createElement(React.Fragment, null,
            ...
            totalPageCount > 1 && (React.createElement(Button, { disabled: currentPage === totalPageCount, onClick: () => NextFunc(), key: totalPageCount + 10 }, next))),
