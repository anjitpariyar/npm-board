 ...
 * @returns
 */
export const usePagination = ({ totalCount, pageSize = 10, currentPage = 0, }) => {
 ...
 * @returns
 */
export const paginationStyle = ({ color = "#000", backgroundColor = "transparent", activeBackground = "rgba(0, 0, 0, 0.04)", activeColor = "#000", align = "center", customStyle, }) => {
    const Ul = styled.ul `
    display: flex;
