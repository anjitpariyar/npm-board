...
const CommentsWrapper = ({ datas, CommentForm, CommentBox, }) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement("div", { style: { marginTop: "60px" } }, datas.map((data, index) => {
            return (react_1.default.createElement(CommentBox, Object.assign({}, data, { key: index.toString() + (data === null || data === void 0 ? void 0 : data.date) + (data === null || data === void 0 ? void 0 : data.id), openComment: openComment, commentId: commentId })));
        })),
