...
const Pagination = ({ onPageChange, currentPage = 1, pageSize, totalData, prev = react_1.default.createElement("span", null, "<"), next = react_1.default.createElement("span", null, ">"), paginationSize = 5, trimmer = true, goto = true, }) => {
