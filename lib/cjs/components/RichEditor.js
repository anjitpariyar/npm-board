...
const draft_js_2 = require("draft-js");
const react_draft_wysiwyg_1 = require("react-draft-wysiwyg");
function RichEditor({ handleContent }) {
    const init = draft_js_1.EditorState.createEmpty();
    const [editorState, setEditorState] = (0, react_1.useState)(init);
